...
run_step_chatty "3/5 src.models.bert" 				python -m src.models.bert
run_step_chatty "4/5 src.train_model_transformer_attentiontypes"               python -m src.train_model_transformer_attentiontypes
